            ...
            for j in range(num_col):
                if stride * i + win <= raw and stride * j + win <= col:
                    img_patches[:, :, :, :, count] = img[
                        :, :, stride * i : stride * i + win, stride * j : stride * j + win
                    ]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train-path", type=str, default="/mnt/sdd/kbs/proxyrestore/OneRestore/data/CDD-11_og/images", help="Train path")
    parser.add_argument("--data-name", type=str, default="dataset.h5", help="Data name")

    parser.add_argument("--gt-name", type=str, default="000.clear", help="HQ name")
    parser.add_argument(
        "--degr_type",
        type=list,
        default=[
    ...
    # old_classes = sorted(os.listdir("OneRestore/data/CDD-11_og/images"))
    # args.degr_type = [old_class.split(".")[1] for old_class in old_classes]
