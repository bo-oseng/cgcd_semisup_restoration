...
def main(args):
    ...
    # old_classes = sorted(os.listdir("OneRestore/data/degradations_with_real/train_o"))
    # new_classes = list(set(sorted(os.listdir("OneRestore/data/degradations_with_real/train_n1"))) - set(old_classes))
...
if __name__ == '__main__':
    ...
    # load model
    parser.add_argument("--embedder_model_path", type=str, default = "OneRestore/ckpts/og/embedder_model.tar", help = 'embedder model path')
    parser.add_argument("--restore_model_path", type=str, default = "OneRestore/ckpts/og/onerestore_cdd-11.tar", help = 'restore model path')
    ...
    parser.add_argument("--input", type=str, default = "OneRestore/data/degradation_with_real/012.real_haze", help = 'image path')
    parser.add_argument("--output", type=str, default = "OneRestore/output/012.real_haze/", help = 'output path')
